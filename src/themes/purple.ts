...
const themeOptions: ThemeOptions = {
  ...
  palette: {
    ...
    primary: {
      light: FUGA_COLORS.PURPLE[200],
      main: FUGA_COLORS.PURPLE[300],
    },
    secondary: {
      main: FUGA_COLORS.PURPLE[300],
    },
    ...
    tabs: {
      primary: {
        backgroundColor: FUGA_COLORS.PURPLE[300],
      ...
      default: {
        ...
        indicator: FUGA_COLORS.PURPLE[300],
      },
    },
    navBar: {
      primary: {
  ...
  overrides: {
    ...
    MuiChip: {
      ...
      colorPrimary: {
        backgroundColor: FUGA_COLORS.PURPLE[200],
      },
      outlined: {
      ...
      outlinedPrimary: {
        borderColor: FUGA_COLORS.PURPLE[300],
        backgroundColor: FUGA_COLORS.PURPLE[50],
        color: FUGA_COLORS.PURPLE[900],
      },
      deleteIcon: {
        color: FUGA_COLORS.GREY[900],
        "&:hover": {
